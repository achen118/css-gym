...
var selectorInstruction = document.getElementById('selector-title');
    ...
    value: function hoverSelector() {
      ...
      document.querySelectorAll(this.currentSelector).forEach(function (el) {
        el.addEventListener("mouseenter", function (event) {
          ...
          if (event.target === document.querySelector('dumbbell')) {
            _this.mark.classList.remove('right');
            _this.mark.classList.add('left');
          } else {
            _this.mark.classList.remove('left');
            _this.mark.classList.add('right');
          }
        });
        el.addEventListener("mouseout", function (event) {
          _this.mark.classList.remove('visible');
        });
      });
    }
  }]);
