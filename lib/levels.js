...
class Level {
  ...
  goToLevel(levelNo) {
    ...
    if (levelNo === 2) {
      ...
      this.level = 2;
      selectorInstruction.innerHTML = "Select the<br />orange dumbbell";
    ...
    if (levelNo === 3) {
      ...
      this.level = 3;
      selectorInstruction.innerHTML = "Select the<br />small dumbbell";
    ...
    if (levelNo === 4) {
      ...
      this.level = 4;
      selectorInstruction.innerHTML = "Select every kettlebell<br />that's next to a dumbbell";
    ...
    if (levelNo === 5) {
      ...
      this.level = 5;
      selectorInstruction.innerHTML = "Select the kettlebell<br />directly on a step";
    ...
    this.hoverSelector();
    selectorInstruction.classList.add('fadein');
  }
